...
MIXER mixer1bendSpacing=600
numberOfBends=5
channelWidth=300
bendLength=2000
height=300 ;

CHANNEL c1 from port_in1 to mixer1 1channelWidth=300 ;
CHANNEL c2 from port_in2 to mixer1 1channelWidth=300 ;
CHANNEL c3 from port_in3 to mixer1 1channelWidth=300 ;
...
PORT port_out_keep, port_out_wasteportRadius=2000;
